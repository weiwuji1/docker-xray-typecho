...
~/.acme.sh/acme.sh --installcert -d $DOMAIN --ecc --fullchain-file /root/web/cert/xray.crt --key-file /root/web/cert/xray.key --reloadcmd docker exec nginx nginx -s force-reload
# 加--force强制更新
